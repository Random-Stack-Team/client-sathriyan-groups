        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
            <div>
              ...
              <h2 className="mt-5 max-w-2xl font-display text-5xl leading-none tracking-[-0.04em] md:text-7xl">
                Building what
                <br />
                <span className="text-brand-gold">comes next.</span>
              </h2>
            </div>

            <p className="max-w-xl text-lg leading-relaxed text-brand-ink/65">
              From homes and commercial spaces to infrastructure and large-scale
              developments, our projects reflect a commitment to thoughtful
              planning, reliable execution, and lasting value.
            </p>
          </div>
            ...
            {filteredProjects.map((project) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-6 flex items-center gap-3 text-sm uppercase tracking-[0.15em]">
